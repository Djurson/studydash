...
export function Credits() {
  ...
  return (
    <main>
      <header className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
      ...
      <section className="">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={filteredData}>
            ...
            <YAxis width={40} tickLine={false} axisLine={false} tickMargin={2} tickFormatter={(value) => `${value} hp`} />
            <ChartTooltip
              cursor={false}
              content={
                <ChartTooltipContent
