...
function AlertDialogContent({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Content> & AlertDialogVariant) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          props.variant === "wider" ? "w-fit" : "w-full max-w-[calc(100%-2rem)] sm:max-w-lg",
          className
        )}
        {...props}
      />
