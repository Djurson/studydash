...
const SIDEBAR_WIDTH_ICON = "3.55rem"; // 3rem
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm">
          {children}
        </div>
      </div>
    </div>
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="sidebar-footer" data-sidebar="footer" className={cn("flex flex-col gap-2 py-3 px-3", className)} {...props} />;
}
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn(
        "group/menu-item relative", // group-data-[collapsible=icon]:pl-1
        className
      )}
      {...props}
    />
