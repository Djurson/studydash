...
type EditContextType = {
  studyResults: Map<string, Course> | undefined;
  setStudyResults: Dispatch<SetStateAction<Map<string, Course> | undefined>>;
};
...
export function EditCourseProvider({ children }: { children: ReactNode }) {
  const [studyResults, setStudyResults] = useState<Map<string, Course>>();
